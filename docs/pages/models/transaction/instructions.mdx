...
Creates compute budget instructions for transactions that need a higher compute limit or priority fee.
...
transaction = Transaction(
    instructions=[compute_limit, compute_price, instruction],
    signers=[sender]
)
```
</Code>
